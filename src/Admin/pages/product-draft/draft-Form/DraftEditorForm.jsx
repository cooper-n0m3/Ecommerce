...
import {
  ...
  productTags,
  productTypeOptions,
} from "../../product/components/SelectOptions.js";
import StepperCompleted from "../../product/components/Stepper.jsx";
import { Flowbite } from "flowbite-react";
import FileUploader from "../draft-Components/DraftFileUploader.jsx";
import FileSingleUploader from "../draft-Components/DraftFileSingleUploader.jsx";
                ...
                <div className="w-full grid grid-cols-2 gap-2 border-opacity-60">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="mb-2 p-1 w-full flex flex-col">
                      ...
                      <TagsSelect
                        defaultSelect={product?.category?.id ?? ''}
                        MAX_SELECT={5}
                  ...
                  <div className="col-span-2">
                    ...
                    <div className=" mb-2 p-1 relative w-full flex flex-col">
                      ...
                      >
                        Size/Volume(ml) (*<span className="text-yellow-400 text-opacity-70">accept only number</span>)
                      </label>
                      <Field
                        className=" h-[35px]  focus:outline-none focus:border-none  bg-gray-700 text-gray-500 focus:text-gray-300"
                        type="number"
                    ...
                    <div className="mb-2 mt-2 p-1 w-full flex flex-col">
                      <label htmlFor="stockQty" className="text-gray-400">
                        Stock Quantity (*<span className="text-yellow-400 text-opacity-70">accept only number</span>)
                      </label>
                      <Field
                        className="h-[35px]   focus:outline-none focus:border-none  bg-gray-700 text-gray-500 focus:text-gray-300"
                        type="number"
