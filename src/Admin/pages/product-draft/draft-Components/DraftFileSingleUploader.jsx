...
const FileSingleUploader = ({ name, draftImage = [], oldThumbnailValue='' ,statusSubmit=false}) => {
  ...
  useEffect(() => {
    ...
    setFieldValue(oldThumbnailValue,draftImage)
  }, [draftImage]);
  
  const handleRemoveDraftImage = (filename) => {
    setGetDraftImage([])
    setFieldValue(oldThumbnailValue,'')
  };
  ...
  return (
    <div className="grid  grid-cols-5 gap-2 border-y p-2 border-opacity-10 border-gray-400">
      <div className="col-span-2">
        {preview.length + getDraftImage.length == 0 && (
          <div
      ...
      <div className="col-span-5">
        ...
        <AnimatePresence transition={{ duration: 0.5 }}>
          ...
          {getDraftImage.length > 0 && (
            <div className="text-gray-400  float-end flex">
              <small className="">
                Delete this thumbnail before uploading new one!
              </small>
