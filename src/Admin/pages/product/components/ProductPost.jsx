    ...
    <>
      <div className="border  border-gray-500 flex p-3 items-center gap-3 justify-evenly mb-4 rounded-lg bg-gray-800">
        ...
        <div className="w-6/12 flex gap-2 justify-end items-center h-[40px]">
          ...
          <Select onChange={handleStatus} id="countries" required>
          ...
          {action == false && (
            <AnimatePresence mode="wait">
              ...
              >
                <Button
                  onClick={(e) => handleSubmit("Save")}
                  className="!normal-case  !gap-2 !text-green-400 !border !border-green-400 !border-opacity-50 text-xs"
                  sx={{ border: "1px solid #ecd9d92a" }}
                >
                  <svg
      ...
      <div className="border  border-gray-500 flex p-3 items-center gap-3 justify-evenly mb-4 rounded-lg bg-gray-800">
        <FormikPost
          actionBtn={action}
          validate={action == true ? ValidationSchema : validationSchemaDraft }
        />
      </div>
      <ScrollToTop />
    </>
