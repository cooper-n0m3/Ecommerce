...
const SortHotelCard = () => {
  return (
    <motion.div
    className="w-full relative   overflow-hidden  dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
        <img
          className="h-[30vh] w-full bg-contain p-[1px]"
      ...
      {/* <div className="px-3  h-[40vh]">
        ...
        <div className="flex items-center justify-between">
          <Button
            className="!normal-case !bg-blue-500 !w-full !text-xs !text-white"
            sx={{
              minWidth: 0,
              height: "40px",
              padding: 0,
